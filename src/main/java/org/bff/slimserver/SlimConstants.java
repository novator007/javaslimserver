...
/**
 * SlimConstants is used to hold SlimServer constant values.
 *
 * @author bfindeisen
 */
public class SlimConstants {

    public static final String PROP_FILE = "/org/bff/slimserver/slimserver.properties";
    ...
    public static final String PROP_PODCAST_ITEMS = "SS_PODCAST_ITEMS";
    public static final String PROP_PODCAST_COUNT = "SS_PODCAST_COUNT";
    public static final String PROP_APP_QUERY = "SS_APP_QUERY";
    public static final String PROP_APP_ITEMS = "SS_XMLBROWSER_ITEMS";
    /*
     * subscribe
     */
