 ...
 * @author bfindeisen
 */
public class SlimAppItem extends SlimApp {
     ...
     */
    @Override
    public Collection<SlimAppItem> getAppItems() {
        return appItems;
    }
     ...
     */
    @Override
    public void setAppItems(Collection<SlimAppItem> appItems) {
    ...
    @Override
    public void addAppItem(SlimAppItem item) {
    ...
    public boolean equals(Object object) {
        ...
        SlimAppItem item = (SlimAppItem) object;
    ...
    public ImageIcon getSmallIcon() {
        ...
        if (icon == null) {
            try {
                ...
                Logger.getLogger(SlimAppItem.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
