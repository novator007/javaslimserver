 ...
 * @author bfindeisen
 */
public class SlimRadioItem extends SlimRadio {
    ...
    public SlimRadioItem(SlimAvailableRadio radio) {
        //super(radio, radioId, null);
        super(radio);
        setRadio(radio);
    ...
    public boolean equals(Object object) {
        ...
        SlimRadioItem item = (SlimRadioItem) object;
    ...
    public ImageIcon getSmallIcon() {
        ...
        if (icon == null) {
            try {
                ...
                Logger.getLogger(SlimRadioItem.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
