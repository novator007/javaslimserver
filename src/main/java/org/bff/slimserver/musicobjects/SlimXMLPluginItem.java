 ...
 * @author bfindeisen
 */
public abstract class SlimXMLPluginItem extends SlimPlayableItem {
    ...
    private String type;
    private int count;
    private Collection<SlimXMLPluginItem> xmlItems;
    private boolean error;
    private String errorMessage;
    private SLIMTYPE slimType;
    private String url;

    public SlimXMLPluginItem(String id) {
        super(id);
        xmlItems = new ArrayList<SlimXMLPluginItem>();
    }
     ...
     */
    public void setSlimType(SLIMTYPE slimType) {
     ...
     * @return the xmlItems
     */
    public Collection<SlimXMLPluginItem> getXmlItems() {
        return xmlItems;
    }
    ...
    public void setUrl(String url) {
        ...
        if (getUrl().startsWith(URL_PREFIX_ARTIST)) {
            setSlimType(SLIMTYPE.ARTIST);
        } else if (getUrl().startsWith(URL_PREFIX_ALBUM)) {
            setSlimType(SLIMTYPE.ALBUM);
        } else if (getUrl().startsWith(URL_PREFIX_GENRE)) {
            setSlimType(SLIMTYPE.GENRE);
        } else if (getUrl().startsWith(URL_PREFIX_YEAR)) {
            setSlimType(SLIMTYPE.YEAR);
        } else {
            setSlimType(SLIMTYPE.OTHER);
        }
    }
    ...
    public void addXMLItem(SlimXMLPluginItem item) {
    ...
    public URL getImageUrl() {
        try {
            ...
            Logger.getLogger(SlimPodcastItem.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public boolean equals(Object object) {
        ...
        SlimXMLPluginItem item = (SlimXMLPluginItem) object;
